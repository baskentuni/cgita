function varargout = compute_cooccurance_matrix_parametric_img(varargin)
...
glm_3D = zeros(max(img_in(:))+1, max(img_in(:))+1); % intensity of zero is accounted as '1', but was later removed
